    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <strong class="text-info">THÙNG RÁC ĐƠN HÀNG</strong>
                </h3>
                <div class="card-tools">
                    <a href="index.php?option=order" class="btn btn-sm btn-danger">
                ...
                <table class="table table-bordered dataTable no-footer" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            <td>
                                <a href="order_update.php"> <?php echo $row['code'];?> </a>
                            </td>
                            <td class="text-center">
                                    <a class="btn btn-info btn-sm"
                                        href="index.php?option=order&cat=retrash&id=<?php echo $row['id'];?>"
                                        role="button">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm"
                                        href="index.php?option=order&cat=delete&id=<?php echo $row['id'];?>"
                                        role="button">
