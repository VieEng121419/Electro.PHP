<?php
	$post = loadModel('post');
    $list = $post->post_list(['type' => 'page','status'=>'trash']);
?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="index.php?option=page" class="btn btn-sm btn-danger">
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="text-center">
                                    <a class="btn btn-info btn-sm"
                                        href="index.php?option=page&cat=retrash&id=<?php echo $row['id'];?>"
                                        role="button">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm"
                                        href="index.php?option=page&cat=delete&id=<?php echo $row['id'];?>"
                                        role="button">
