<?php
	$post = loadModel('post');
	$list = $post->post_list(['type' => 'page','status'=>'index']);
					...
					<?php foreach($list as $row):?>
						<tr role="row" class="odd">
							<td class="sorting_1">
								...
								<?php if($row['status']==1):?>
									<a class="btn btn-success btn-sm" href="index.php?option=page&cat=status&id=<?php echo $row['id'];?>" role="button">
										<i class="fa fa-toggle-on"></i>
									</a>
								<?php else:?>
									<a class="btn btn-danger btn-sm" href="index.php?option=page&cat=status&id=<?php echo $row['id'];?>" role="button">
										<i class="fa fa-toggle-off"></i>
								<?php endif;?>
									<a class="btn btn-info btn-sm" href="index.php?option=page&cat=update&id=<?php echo $row['id'];?>" role="button">
										<i class="fas fa-edit"></i>
									</a>
									<a class="btn btn-danger btn-sm" href="index.php?option=page&cat=deltrash&id=<?php echo $row['id'];?>" role="button">
