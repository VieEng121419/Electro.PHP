...
<form name="form1" action="index.php?option=post&cat=process" enctype="multipart/form-data" method="post">
            ...
            <div class="row">
               <div class="col-9">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="title" placeholder="Tên sản phẩm" required>
                  </div>
                  <div class="form-group">
               ...
               <div class="col-3">
                  <div class="form-group">
                     ...
                     <select class="form-control" name="topid" required>
                        <option>-- Chọn loại chủ đề--</option>
                        <?php echo $strtopid; ?>
                     </select>
                  </div>
                  <div class="form-group">
