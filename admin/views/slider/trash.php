    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">
            <strong class="text-danger">THÙNG RÁC CỦA LOẠI SẢN PHẨM</strong>
          </h3>
        ...
        <table class="table table-bordered dataTable no-footer" id="myTable">
					...
					<?php foreach($list as $row ): ?>
						<tr role="row" class="odd">
							<td class="sorting_1">
								<img src="../public/images/slider/<?php echo $row['img']; ?>" class="img-fluid" alt="hinh">
								</td>
								<td>
								<?php echo $row['name']; ?>
								</td>
								...
								<td class="text-center">
									...
									<a class="btn btn-info btn-sm" href="index.php?option=slider&cat=retrash&id=<?php echo $row['id']; ?>" role="button">
										<i class="fas fa-edit"></i>
									</a>
									<a class="btn btn-danger btn-sm" href="index.php?option=slider&cat=delete&id=<?php echo $row['id']; ?>" role="button">
