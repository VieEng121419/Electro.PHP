<?php
    ...
    $list = $topic->topic_list(['type' => 'topic','status'=>'trash']);
?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="index.php?option=topic" class="btn btn-sm btn-danger">
                ...
                <table class="table table-bordered dataTable no-footer" id="myTable">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1"
                                aria-label="Tên sản phẩm: activate to sort column ascending" style="width: 527px;">Tên loại
                                sản phẩm</th>   
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                <a href="topic_update.php"> <?php echo $row['name'];?> </a>
                            </td>
                            <td class="text-center">
                                    <a class="btn btn-info btn-sm"
                                        href="index.php?option=topic&cat=retrash&id=<?php echo $row['id'];?>"
                                        role="button">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm"
                                        href="index.php?option=topic&cat=delete&id=<?php echo $row['id'];?>"
                                        role="button">
