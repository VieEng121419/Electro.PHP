<?php
    ...
    $list = $product->product_list(['type' => 'product','status'=>'trash']);
?>
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <strong class="text-info">THÙNG RÁC SẢN PHẨM </strong>
                </h3>
                <div class="card-tools">
                    <a href="index.php?option=product" class="btn btn-sm btn-danger">
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="text-center">
                                    <a class="btn btn-info btn-sm"
                                        href="index.php?option=product&cat=retrash&id=<?php echo $row['id'];?>"
                                        role="button">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm"
                                        href="index.php?option=product&cat=delete&id=<?php echo $row['id'];?>"
                                        role="button">
