        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <strong class="text-info">CẬP NHẬT THÀNH VIÊN</strong>
                    </h3>
                        ...
                        <div class="col-9">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email"
                                    value="<?php echo $row['email'];?>" placeholder="Thư điện tử">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username"
                                    value="<?php echo $row['username'];?>" placeholder="Tên đăng nhập">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-3">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status">
                                    ...
                                    <option <?php if($row['status']==2){echo 'selected';}?> value="2">Chưa xuất bản
                                    </option>
                                </select>
                            </div>
                        </div>
