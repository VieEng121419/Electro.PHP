<?php
    ...
    $list = $category->category_list(['type' => 'category','status'=>'trash']);
?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="index.php?option=category" class="btn btn-sm btn-danger">
                ...
                <table class="table table-bordered dataTable no-footer" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                <a href="category_update.php"> <?php echo $row['name'];?> </a>
                            </td>
